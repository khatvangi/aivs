...
|---|---|---|---:|---:|---:|---:|
| **mechanism_classifier** — the AIVS manuscript case study | `examples/mechanism_classifier_audit.py` | `examples/out/mechanism_classifier_audit_published.json` | 2 | 22 | 8 | 4 |
...
**If you arrived here from the AIVS manuscript**, the verification record
